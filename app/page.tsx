          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="relative h-[400px] md:h-[500px] rounded-xl overflow-hidden">
                <Image src="/chocolate-making-process-artisan-hands-crafting.jpg" alt="Nuestra Esencia" fill className="object-cover" />
              </div>
              <div>
        ...
        <section className="section-cream py-16 md:py-24">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 stagger-grid">
              {[
                { name: "Trufas de chocolate negro", image: "/trufas.png" },
                { name: "Bombones volcanes", image: "/volcanes.png" },
                { name: "Tabletas bariloches", image: "/barras-bariloches.png" },
                { name: "Alfajores caseros", image: "/alfajores.jpg" },
                { name: "Honguitos mágicos", image: "/honguito.png" },
                { name: "Frutos secos", image: "/frutos-secos.png" },
                { name: "Pistachos", image: "/pistachos.png" },
                { name: "Kucken", image: "/kucken.png" },
              ].map((product, index) => (
                <Card
                  key={index}
                  className="overflow-hidden bg-kraft-beige border-none shadow-sm hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
        ...
        <section className="section-dark py-16 md:py-24 bg-coffee-brown text-warm-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative h-[400px] md:h-[500px] rounded-xl overflow-hidden">
                <Image src="/chocolattina.png" alt="Experiencia La Chocolattina" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
              ...
              <div className="relative h-[400px] rounded-xl overflow-hidden">
                <Image src="/mapa-chocolattina.png" alt="Ubicación" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
