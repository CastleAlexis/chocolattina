    ...
    <div className="min-h-screen">
      ...
      <main className="pt-24">
        ...
        <section className="relative h-[50vh] flex items-center justify-center">
          ...
          <Image src="/ensenada.png" alt="Nuestra Historia" fill className="object-cover" />
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="space-y-8">
              ...
              <div className="relative h-[400px] md:h-[500px] rounded-xl overflow-hidden my-12">
                <Image src="/chocolate-artisan-workshop-hands-crafting-detail.jpg" alt="Proceso Artesanal" fill className="object-cover" />
              </div>
              ...
              <div className="relative h-[300px] md:h-[400px] rounded-xl overflow-hidden my-12">
                <Image src="/ensenada.png" alt="Ensenada" fill className="object-cover" />
              </div>

              <div>
                <h2 className="text-3xl font-semibold text-chocolate-dark mb-6">Hoy</h2>
                <p className="text-coffee-brown text-lg leading-relaxed mb-4">
                  Hoy, La Chocolattina es más que una chocolatería. Es un lugar de encuentro, donde familias, parejas y
                ...
                <p className="text-coffee-brown text-lg leading-relaxed">
                  ...
                  el amor que ponemos en cada detalle. En La Chocolattina, siempre serás bienvenido.
                </p>
              </div>
            </div>
          </div>
